        ...
        findViewById(R.id.regionSearch).setOnClickListener(
                new OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        info.ak = "1IXH02jT2qulvsbt3VoOZYs0PawIUcPd";
                        info.geoTableId = 160672;
                        info.tags = "";
                        info.q = "天安门";
                        info.region = "北京市";
        ...
        findViewById(R.id.detailsSearch).setOnClickListener(
                new OnClickListener() {
                    public void onClick(View v) {
                        ...
                        info.geoTableId = 160672;
                        //info.uid = 18622266;
                        info.poiId = "2209138032"; //考虑到数据的溢出，请使用podId代替uid。
        ...
        findViewById(R.id.cloudRgc).setOnClickListener(
                new OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        info.geoTableId = 160672;  //注：请开发者使用自己AK下的geo_table
                        info.location = "39.936801,116.453892";//区工人体育场东路辅路
